    ...
    <div class="row q-col-gutter-lg">
      <div class="col-12 col-md-4">
        <QCard class="q-pa-lg flex flex-col gap-4 h-full noisy">
          <div class="flex items-center gap-sm">
            <img src="@/assets/home_imgs/cards/ps5.svg" alt="ps5 card image" />
      ...
      <div class="col-12 col-md-4">
        <QCard class="q-pa-lg flex flex-col gap-4 h-full noisy">
          <div class="flex items-center gap-sm">
            <img
              src="@/assets/home_imgs/cards/controller.svg"
              alt="ps5 card image"
            />
      ...
      <div class="col-12 col-md-4">
        <QCard class="q-pa-lg flex flex-col gap-4 h-full noisy">
          <div class="flex items-center gap-sm">
            <img
              src="@/assets/home_imgs/cards/fortnite.svg"
              alt="ps5 card image"
            />
...
.noisy {
  ...
  //   rgba(23, 23, 231, 0);
  background: url('@/assets/home_imgs/cards/grain.svg');
