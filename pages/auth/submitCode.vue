...
<template>
  <QPage class="px-6xl column pb-3xl">
    <QCard
      class="flex pa-xs m-lg flex-col !min-h-160 col w-full gap-3 items-center mx-auto justify-center !rounded-3rem full-height"
    >
      <h3 class="text-primary text-h5">ورود به حساب کاربری</h3>
