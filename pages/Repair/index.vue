...
globalStore.setCurrentTextName('خدمات تعمیر ')
</script>
...
<template>
  <main>
    <section class="row q-col-gutter-lg pb-lg">
      ...
      <div class="col-12 col-lg-9 flex flex-col pa-lg gap-5">
        <h3 class="text-text-primary text-h6">
          بزرگ تریم مرجع تعمیر دسته و کنسول ایران
        </h3>
        ...
        <div
          class="bg-black text-primary f-text-34-52 tracking-tighter grid place-content-center rounded-lg min-h-45"
        >
          جایگاه بنر برای تعمیر خرابی
        </div>
      </div>
      <!--  -->
      ...
      >
        <h4 class="text-primary pb-lg text-xl">قیمت خدمات تعمیر دسته</h4>
        <SmallDetail
